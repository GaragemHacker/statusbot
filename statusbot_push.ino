...
Esta versao utiliza algoritimo simples com leitura da porta digital para fazer a inversao do estado atual do botao.
o algoritmo ira funcionar apenas com botao "push/campainha"(tipo de botao que fecha o contato apenas quando pressionado)
